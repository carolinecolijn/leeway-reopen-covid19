...
source(file.path(this_folder, "01-fit-belgium.R"))
source(file.path(this_folder, "01-fit-new-zealand.R"))
source(file.path(this_folder, "01-fit-sweden.R"))
source(file.path(this_folder, "01-fit-uk.R"))
source(file.path(this_folder, "01-fit-japan.R"))
source(file.path(this_folder, "01-fit-germany.R"))
